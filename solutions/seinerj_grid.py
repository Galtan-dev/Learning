"""
Script pro nalezení největšího součinu 4 sousedních čísel
"""
...
# Rozdělení řetězce na čísla a převedení na seznam celých čísel
numbers = [int(num) for num in data.split()]

# Vytvoření matice z listu čísel a vytvoření zadané matice 20*20
matrix = [numbers[i:i + 20] for i in range(0, len(numbers), 20)]

# zobrazení výsledku
result = find_largest_product(matrix)
print("Největší součin čtyř sousedních čísel je:", result)
